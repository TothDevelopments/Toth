...
public class MainActivity extends AppCompatActivity {
    ...
    private void initUI() {
        ...
        if (useMenuResource) {
            ...
            AHBottomNavigationItem item2 = new AHBottomNavigationItem(R.string.tab_2, R.drawable.ic_library_books_white_24dp, R.color.color_tab_2);
            AHBottomNavigationItem item3 = new AHBottomNavigationItem(R.string.tab_3, R.drawable.ic_library_books_white_24dp, R.color.color_tab_3);
