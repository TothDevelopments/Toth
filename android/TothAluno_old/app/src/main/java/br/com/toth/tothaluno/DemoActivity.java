...
public class DemoActivity extends AppCompatActivity {
	...
	private void initUI() {
		...
		if (useMenuResource) {
			...
			AHBottomNavigationItem item1 = new AHBottomNavigationItem(R.string.tab_1, R.drawable.ic_library_books_white_24dp, R.color.color_tab_1);
			AHBottomNavigationItem item2 = new AHBottomNavigationItem(R.string.tab_2, R.drawable.ic_today_white_24dp, R.color.color_tab_2);
			AHBottomNavigationItem item3 = new AHBottomNavigationItem(R.string.tab_3, R.drawable.ic_chat_white_24dp, R.color.color_tab_3);
		...
		if (useMenuResource) {
			...
			if (addItems) {
				AHBottomNavigationItem item4 = new AHBottomNavigationItem(getString(R.string.tab_4),
						ContextCompat.getDrawable(this, R.drawable.ic_today_white_24dp),
